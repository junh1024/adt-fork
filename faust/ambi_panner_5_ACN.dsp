...
with {
  ...
  SN3D_1_1 = sqrt(3) * (1/sqrt(3));
  SN3D_1_0 = sqrt(3) * (1/sqrt(3));

  SN3D_2_2 = (sqrt(15)/2) * (1/sqrt(5));
  SN3D_2_1 = (sqrt(15)/2) * (1/sqrt(5));
  SN3D_2_0 = (sqrt(5)/2)  * (1/sqrt(5));

  SN3D_3_3 = (sqrt(35/8))  * (1/sqrt(7));
  SN3D_3_2 = (sqrt(105)/2) * (1/sqrt(7));
  SN3D_3_1 = (sqrt(21/8))  * (1/sqrt(7));
  SN3D_3_0 = (sqrt(7)/2)   * (1/sqrt(7));

  SN3D_4_4 = (sqrt(35)  *(3/8))   * (1/3); // 1/sqrt(9)
  SN3D_4_3 = (sqrt(35/2)*(3/2))   * (1/3);
  SN3D_4_2 = (sqrt(5)   *(3/4))   * (1/3);
  SN3D_4_1 = (sqrt(5/2) *(3/4))   * (1/3);
  SN3D_4_0 = (3/8)                * (1/3);

  SN3D_5_5 = (sqrt(77/2) *(3/8) ) * (1/sqrt(11));
  SN3D_5_4 = (sqrt(385)  *(3/8) ) * (1/sqrt(11));
  SN3D_5_3 = (sqrt(385/2)*(1/8) ) * (1/sqrt(11));
  SN3D_5_2 = (sqrt(1155) *(1/4) ) * (1/sqrt(11));
  SN3D_5_1 = (sqrt(165)  *(1/8) ) * (1/sqrt(11));
  SN3D_5_0 = (sqrt(11)   *(1/8) ) * (1/sqrt(11));
  ...
  // degree = 4
  acn_dirCosine(16) = SN3D_4_4 * x * y * ( pow(x,2) - pow(y,2) );                       //                
  acn_dirCosine(17) = SN3D_4_3 * y * z * ( (3*pow(x,2) ) - pow(y,2));                   //                
  acn_dirCosine(18) = SN3D_4_2 * x * y * ( (7*pow(z,2)) - 1 );                          //                   
  acn_dirCosine(19) = SN3D_4_1 * y * z * ( (7*pow(z,2)) - 3 );                          //                
  acn_dirCosine(20) = SN3D_4_0 * ( (35*pow(z,4)) - (30*pow(z,2)) + 3 );                 // 
  acn_dirCosine(21) = SN3D_4_1 * x * z * ( (7*pow(z,2)) - 3);                           // 
  ...
  acn_dirCosine(26) = SN3D_5_4 * x * y * z * (pow(x,2) - pow(y,2));
  acn_dirCosine(27) = SN3D_5_3 * y * ( pow(y,4) - (2*pow(x,2)*pow(y,2)) - (3*pow(x,4))  -  (8*pow(y,2)*pow(z,2))   +  (24*pow(x,2)*pow(z,2)) );
  acn_dirCosine(28) = SN3D_5_2 * x * y * z * ( (2*pow(z,2)) - pow(x,2)  -  pow(y,2)  );
